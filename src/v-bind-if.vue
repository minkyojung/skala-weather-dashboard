...
<template>
    <div class="practice-section">
        ...
        <div v-else-if="score >= 80" style="color: blue; font-weight: bold;">합격 등급 : B 학점 (양호합니다)</div>
        <div v-else-if="score >= 70" style="color: orange; font-weight: bold;">합격 등급 : C 학점 (조금 더 분발하세요)</div>
